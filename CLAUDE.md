...
cc-hud is a customizable status line formatter for Claude Code CLI that displays model info, git branch, token usage, and other metrics. It functions as both:
...
|----|------|---|-------|------|
| #384 | 7:38 AM | ✅ | Corrected merge note to reference ccstatusline as original project name | ~314 |
| #383 | " | ✅ | Corrected Related Projects section to reference original ccstatusline project | ~309 |
| #380 | " | ✅ | Global replacement of ccstatusline with cc-hud throughout README | ~385 |
| #379 | " | ✅ | Updated Development Setup git clone instructions to use correct repository | ~280 |
| #377 | " | ✅ | Updated Claude Code Integration section header from claude-hud to cc-hud | ~274 |
| #375 | 7:37 AM | ✅ | Updated Windows installation comment from "Run claude-hud" to "Run cc-hud" | ~245 |
| #373 | " | ✅ | Updated configuration section header from "Configure claude-hud" to "Configure cc-hud" | ~228 |
| #369 | " | ✅ | Updated all bunx command references from claude-hud to cc-hud in README | ~297 |
| #365 | " | ✅ | Updated README branding from claude-hud to cc-hud | ~272 |
| #363 | 7:36 AM | ✅ | Updated repository URL from ccstatusline to cc-hud in package.json | ~323 |
| #356 | 7:17 AM | ✅ | Removed btc-price widget from ccstatusline configuration | ~295 |
</claude-mem-context>